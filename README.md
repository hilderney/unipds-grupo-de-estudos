...
Nosso objetivo é criar uma comunidade ativa de aprendizado, compartilhamento de conhecimento e construção prática, conectando os conteúdos da pós-graduação com aplicações reais de mercado.
...
* Fortalecer a comunidade entre os alunos da turma
